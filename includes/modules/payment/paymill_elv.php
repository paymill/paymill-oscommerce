...
class paymill_elv extends paymill
{
    ...
    function install()
    {
        ...
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_group_id, sort_order, set_function, use_function, date_added) values ('" . MODULE_PAYMENT_PAYMILL_ELV_TMP_STATUS_ID_TITLE . "', 'MODULE_PAYMENT_PAYMILL_ELV_TMP_STATUS_ID', '" . $tmp_status_id . "',  '6', '8', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
